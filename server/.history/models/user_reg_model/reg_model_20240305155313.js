        ...
        connectDB.queryObject(sql_reg_commands ,(error, result) => {
            if (error) {
                ...
                if(result == true){
                    ...
                    var creating_table_command = `CREATE TABLE IF NOT EXISTS ${email} (identifier_key INT NOT NULL , food_name VARCHAR (50) NOT NULL , food_id INT NOT NULL, quantity INT NOT NULL , weight INT NOT NULL, expDate VARCHAR (8) NOT NULL , UNIQUE (food_id , identifier_key), PRIMARY KEY (food_id , identifier_key))` ; 
