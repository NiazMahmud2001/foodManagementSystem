import { StyleSheet,View, Text, TextInput, TouchableOpacity, Alert, ImageBackground, Image , Animated} from 'react-native'
...
const Login = ({navigation}) => {
    ...
    const [moveLoader , setMoveLoader] = useState(true)
    ...
    <Loader1 style={moveLoader && {transform:[
